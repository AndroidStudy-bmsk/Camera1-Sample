...
public class MainActivity extends AppCompatActivity implements
    ...
    private static final int[] FLASH_OPTIONS =
            {CameraView.FLASH_AUTO, CameraView.FLASH_OFF, CameraView.FLASH_ON,};

    private static final int[] FLASH_ICONS =
            {R.drawable.ic_flash_auto, R.drawable.ic_flash_off, R.drawable.ic_flash_on,};

    private static final int[] FLASH_TITLES =
            {R.string.flash_auto, R.string.flash_off, R.string.flash_on,};
    ...
    protected void onResume() {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA)
            ...
            ConfirmationDialogFragment.newInstance(R.string.camera_permission_confirmation,
                    ...
                    R.string.camera_permission_not_granted).show(getSupportFragmentManager(),
                    FRAGMENT_DIALOG);
        } else {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId == R.id.aspect_ratio) {
            ...
            if (mCameraView != null && fragmentManager.findFragmentByTag(FRAGMENT_DIALOG)
                    == null) {
    ...
    private CameraView.Callback mCallback = new CameraView.Callback() {
        ...
        public void onPictureTaken(CameraView cameraView, final byte[] data) {
            ...
            Toast.makeText(cameraView.getContext(), R.string.picture_taken,
                    Toast.LENGTH_SHORT).show();
    ...
    public static class ConfirmationDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity()).setMessage(
                    args.getInt(ARG_MESSAGE)).setPositiveButton(android.R.string.ok,
                    (dialog, which) -> {
                    ...
                    (dialog, which) -> Toast.makeText(getActivity(), args.getInt(ARG_NOT_GRANTED_MESSAGE),
